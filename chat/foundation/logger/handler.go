...
// log level is being logged for the event handling.
...
// Enables reports wherther the handler handles records at the given level.
// The handler ignores record whose level is lower.
func (h *logHandler) Enabled(ctx context.Context, level slog.Level) bool {
	return h.handler.Enabled(ctx, level)
}

// WithAttrs returns a new JSONHandler whos attributes consists
...
// or in a Reconrd, should be qualified by the sequence of group names
