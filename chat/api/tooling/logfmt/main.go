...
func init() {
	flag.StringVar(&service, "service", "", "filter which service to use")
...
func main(){
	...
	for scanner.Scan(){
		...
		// ArdanLabs likes always having a traceid present in the logs
		...
		for k, v := range m{
			...
			//especially since the map ordering is random
